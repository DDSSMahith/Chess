...
public class RefScript : MonoBehaviour
{
    ...
    public void LineMovePlate(int xIncrement, int yIncrement)
    {
        ...
        if (sc.PositionOnBoard(x, y) && sc.GetPosition(x, y).GetComponent<RefScript>().player != player)
        {
    ...
    public void PointMovePlate(int x, int y)
    {
        ...
        if (sc.PositionOnBoard(x, y))
        {
            ...
            else if (cp.GetComponent<RefScript>().player != player)
            {
                MovePlateAttackSpawn(x, y);
            }
        }
    ...
    public void PawnMovePlate(int x, int y)
    {
        ...
        if (sc.PositionOnBoard(x, y))
        {
            ...
            sc.GetPosition(x + 1, y).GetComponent<RefScript>().player != player)
            {
    ...
    public void MovePlateSpawn(int matrixX, int matrixY, bool isAttack = false)
    {
        ...
        Tile mpScript = mp.GetComponent<Tile>();
